...
\begin{deluxetable}{ccccc}
  ...
  \tablehead{\colhead{Region} & \colhead{Average $\beta$} & \colhead{ Total Dust Mass} & \colhead{Average Dust Surface Density} & \colhead{Average Temperature} \\ & &  $\left[10^5M_\odot\right]$ & $\left[M_\odot pc^{-2}\right]$ &[K]}
  \startdata
...
\begin{deluxetable}{ccccc}
  ...
  \tablehead{\colhead{Region} & \colhead{Average $\beta$} & \colhead{ Total Dust Mass} & \colhead{Average Dust Surface Density} & \colhead{Average Temperature} \\ & &  $\left[10^5M_\odot\right]$ & $\left[10^5M_\odot pc^{-2}\right]$ &[K]}
  \startdata
